...
{
	internal class StringDataGenerator : IStringDataGeneratorProvider
	{
		...
		public string GenerateRandomString(int minLength, int maxLength, bool includeSpecialCharacters, bool includeNumbers)
		{
