...
namespace WaveTech.Scutex.Framework
{
	...
	internal class OSVersionInfo : IComparable, ICloneable
	{
		...
		private static readonly OSVersionInfo _Win32s = new OSVersionInfo(OSPlatformId.Win32s, MajorVersionConst.Win32s, MinorVersionConst.Win32s, true);
		private static readonly OSVersionInfo _Win95 = new OSVersionInfo(OSPlatformId.Win32Windows, MajorVersionConst.Win95, MinorVersionConst.Win95, true);
		private static readonly OSVersionInfo _Win98 = new OSVersionInfo(OSPlatformId.Win32Windows, MajorVersionConst.Win98, MinorVersionConst.Win98, true);
		private static readonly OSVersionInfo _WinME = new OSVersionInfo(OSPlatformId.Win32Windows, MajorVersionConst.WinME, MinorVersionConst.WinME, true);
		private static readonly OSVersionInfo _WinNT351 = new OSVersionInfo(OSPlatformId.Win32NT, MajorVersionConst.WinNT351, MinorVersionConst.WinNT351, true);
		private static readonly OSVersionInfo _WinNT4 = new OSVersionInfo(OSPlatformId.Win32NT, MajorVersionConst.WinNT4, MinorVersionConst.WinNT4, true);
		private static readonly OSVersionInfo _Win2000 = new OSVersionInfo(OSPlatformId.Win32NT, MajorVersionConst.Win2000, MinorVersionConst.Win2000, true);
		private static readonly OSVersionInfo _WinXP = new OSVersionInfo(OSPlatformId.Win32NT, MajorVersionConst.WinXP, MinorVersionConst.WinXP, true);
		private static readonly OSVersionInfo _Win2003 = new OSVersionInfo(OSPlatformId.Win32NT, MajorVersionConst.Win2003, MinorVersionConst.Win2003, OSProductType.Server, true);
		private static readonly OSVersionInfo _WinXPx64 = new OSVersionInfo(OSPlatformId.Win32NT, MajorVersionConst.WinXPx64, MinorVersionConst.WinXPx64, OSProductType.Workstation, true);
		private static readonly OSVersionInfo _WinCE = new OSVersionInfo(OSPlatformId.WinCE, true); // TODO: WinCE version
		private static readonly OSVersionInfo _Vista = new OSVersionInfo(OSPlatformId.Win32NT, MajorVersionConst.Vista, MinorVersionConst.Vista, OSProductType.Workstation, true);
		private static readonly OSVersionInfo _Win2008 = new OSVersionInfo(OSPlatformId.Win32NT, MajorVersionConst.Win2008, MinorVersionConst.Win2008, OSProductType.Server, true);
		private static readonly OSVersionInfo _Win2008R2 = new OSVersionInfo(OSPlatformId.Win32NT, MajorVersionConst.Win2008R2, MinorVersionConst.Win2008R2, OSProductType.Server, true);
		private static readonly OSVersionInfo _Win7 = new OSVersionInfo(OSPlatformId.Win32NT, MajorVersionConst.Win7, MinorVersionConst.Win7, OSProductType.Workstation, true);
		...
		public static OSVersionInfo GetOSVersionInfo(OSVersion v)
		{
			switch (v)
			{
				...
				case OSVersion.WinXPx64: return WinXPx64;
				case OSVersion.WinCE: return WinCE;
				case OSVersion.Vista: return Vista;
				case OSVersion.Win2008: return Win2008;
				case OSVersion.Win2008R2: return Win2008R2;
				case OSVersion.Win7: return Win7;
		...
		public string OSPlatformIdString
		{
			get
			{
				switch (OSPlatformId)
				{
					case OSPlatformId.Win32s: return "Windows 32s";
					case OSPlatformId.Win32Windows: return "Windows 32";
					case OSPlatformId.Win32NT: return "Windows NT";
					case OSPlatformId.WinCE: return "Windows CE";
		...
		public string OSSuiteString
		{
			get
			{
				...
				if (OSSuiteFlag(flags, OSSuites.Enterprise))
					switch (OSVersion)
					{
						case OSVersion.WinNT4: OSSuiteStringAdd(ref s, "Enterprise"); break;
						case OSVersion.Win2000: OSSuiteStringAdd(ref s, "Advanced"); break;
						case OSVersion.Win2003: OSSuiteStringAdd(ref s, "Enterprise"); break;
					}
			...
			get
			{
				switch (OSProductType)
				{
					case OSProductType.Workstation:
						...
						switch (OSVersion)
						{
							case OSVersion.Win32s: return String.Empty;
							case OSVersion.Win95: return String.Empty;
							case OSVersion.Win98: return String.Empty;
							case OSVersion.WinME: return String.Empty;
							case OSVersion.WinNT351: return String.Empty;
							case OSVersion.WinNT4: return "Workstation";
							case OSVersion.Win2000: return "Professional";
							...
							case OSVersion.Win2003: return String.Empty;
							case OSVersion.WinXPx64: return String.Empty;
							case OSVersion.WinCE: return String.Empty;
							...
							case OSVersion.Win7:
								...
								switch (OSArchitecture)
								{
									...
									default: throw new InvalidOperationException("Invalid OSArchitecture: " + OSArchitecture);
								}
		...
		public OSVersion OSVersion
		{
			get
			{
				switch (OSPlatformId)
				{
					case OSPlatformId.Win32s: return OSVersion.Win32s;

					case OSPlatformId.Win32Windows:

						switch (OSMinorVersion)
						{
							case MinorVersionConst.Win95: return OSVersion.Win95;
							case MinorVersionConst.Win98: return OSVersion.Win98;
							case MinorVersionConst.WinME: return OSVersion.WinME;
					...
					case OSPlatformId.Win32NT:
						...
						{
							case MajorVersionConst.WinNT351: return OSVersion.WinNT351;
							case MajorVersionConst.WinNT4: return OSVersion.WinNT4;

							case MajorVersionConst.WinNT5:

								switch (OSMinorVersion)
								{
									case MinorVersionConst.Win2000: return OSVersion.Win2000;
									case MinorVersionConst.WinXP: return OSVersion.WinXP;
									...
									case MinorVersionConst.Win2003:
										...
										{
											case OSProductType.Workstation: return OSVersion.WinXPx64;

											case OSProductType.DomainController:
											case OSProductType.Server:
												return OSVersion.Win2003;

											default: throw new InvalidOperationException("Invalid Win32NT WinNT5.2 OSProductType: " + OSProductType);
										}
							...
							case MajorVersionConst.Vista:
								...
								switch (_OSProductType)
								{
									case OSProductType.Workstation:
										switch (OSMinorVersion)
										{
											case MinorVersionConst.Vista: return OSVersion.Vista;
											case MinorVersionConst.Win7: return OSVersion.Win7;
											default: throw new InvalidOperationException("Invalid Win32NT WinNT6 Workstation MinorVersion: " + OSMinorVersion);
										}
									...
									case OSProductType.Server:
										switch (OSMinorVersion)
										{
											case MinorVersionConst.Win2008: return OSVersion.Win2008;
											case MinorVersionConst.Win2008R2: return OSVersion.Win2008R2;
											default: throw new InvalidOperationException("Invalid Win32NT WinNT6 Server MinorVersion: " + OSMinorVersion);
										}

									default: throw new InvalidOperationException("Invalid Win32NT WinNT6 OSProductType: " + OSProductType);
								}

							default: throw new InvalidOperationException("Invalid Win32NT MajorVersion: " + OSMajorVersion);
						}

					case OSPlatformId.WinCE: return OSVersion.WinCE;
		...
		public string OSVersionString
		{
			get
			{
				switch (OSVersion)
				{
					case OSVersion.Win32s: return "Windows 32s";
					case OSVersion.Win95: return "Windows 95";
					case OSVersion.Win98: return "Windows 98";
					case OSVersion.WinME: return "Windows ME";
					case OSVersion.WinNT351: return "Windows NT 3.51";
					case OSVersion.WinNT4: return "Windows NT 4";
					case OSVersion.Win2000: return "Windows 2000";
					case OSVersion.WinXP: return "Windows XP";
					case OSVersion.Win2003: return "Windows 2003";
					case OSVersion.WinXPx64: return "Windows XP x64";
					case OSVersion.WinCE: return "Windows CE";
					case OSVersion.Vista: return "Windows Vista";
					case OSVersion.Win2008: return "Windows 2008";
					case OSVersion.Win2008R2: return "Windows 2008 R2";
					case OSVersion.Win7: return "Windows 7";
	...
	internal class OperatingSystemVersion : OSVersionInfo
	{
		...
		public static OperatingSystemVersion Current
		{
			get
			{
				if (Object.ReferenceEquals(sCurrent, null)) sCurrent = new OperatingSystemVersion();
		...
		private static OSPlatformId GetOSPlatformId(int platformId)
		{
			switch (platformId)
			{
				case VerPlatformId.Win32s: return OSPlatformId.Win32s;
				case VerPlatformId.Win32Windows: return OSPlatformId.Win32Windows;
				case VerPlatformId.Win32NT: return OSPlatformId.Win32NT;
				case VerPlatformId.WinCE: return OSPlatformId.WinCE;
		...
		private static OSProductType GetOSProductType(byte productType)
		{
			switch (productType)
			{
				case VerProductType.VER_NT_WORKSTATION: return OSProductType.Workstation;
				case VerProductType.VER_NT_DOMAIN_CONTROLLER: return OSProductType.DomainController;
				case VerProductType.VER_NT_SERVER: return OSProductType.Server;
		...
		private void InitArchitecture()
		{
			...
			switch (lpSystemInfo.uProcessorInfo.wProcessorArchitecture)
			{
				...
				default: throw new ApplicationException("Unknown architecture: " + lpSystemInfo.uProcessorInfo.wProcessorArchitecture);
			}
		}
